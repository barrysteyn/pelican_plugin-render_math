...
Requires [BeautifulSoup4](http://www.crummy.com/software/BeautifulSoup/bs4/doc/) be installed. **Note**: If you
are using other plugins that alter summaries, this plugin should come *last*. **Default Value**: `True`
